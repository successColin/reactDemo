 ...
 * @Last Modified time: 2021-01-14 17:17:36
 * @Desc: 框架主体内容（资源管理器框架）
 */
...
import {
  ...
  prevSetFormData,
  unique,
  reducerVariableToArray, multiDataComparison, jumpFileOfCommon, validMatchMultiTrigger,
} from '@/utils/common';
...
class ContentContainer extends Component {
  ...
  getTabContent = (isSingleTab = false) => {
    const { externalParameters, stepList, mainListData, loadingStatus, formData, listDataObj, listQueryParams, tabDropDownData = {}, listSelectedRows, originFormData, relationFileObj, elementMap = {} } = this.state;
