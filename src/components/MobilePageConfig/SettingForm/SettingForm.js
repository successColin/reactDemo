 ...
 * @Last Modified time: 2019-12-10 16:03:09
 * @Desc: 高级设置的表单
 */
...
class SettingForm extends FormItems {
  ...
  getFormConfigs = () => {
    const { setRowData, activeRowIndex, activeRow = {}, tabInfo, form, doSaveFrameTab, fromType = 'pageConfig' } = this.props;
    ...
    return [
      {
        ...
        ignore: (tabInfo.showType === 1 || tabInfo.showType === 4) ? false : ELEMENT_DETAIL_CONFIG.hasRelationTab.indexOf(basetype) === -1,
        component: (
          <SearchSelect
            modalContentType="relateTable"
            isReadOnly={true}
